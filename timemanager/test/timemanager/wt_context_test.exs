...
#       valid_attrs = %{end: ~N[2022-10-24 07:20:00], start: ~N[2022-10-24 07:20:00]}

#       assert {:ok, %WT{} = wt} = WTContext.create_wt(valid_attrs)
#       assert wt.end == ~N[2022-10-24 07:20:00]
#       assert wt.start == ~N[2022-10-24 07:20:00]
#     end
...
#       wt = wt_fixture()
#       update_attrs = %{end: ~N[2022-10-25 07:20:00], start: ~N[2022-10-25 07:20:00]}

#       assert {:ok, %WT{} = wt} = WTContext.update_wt(wt, update_attrs)
#       assert wt.end == ~N[2022-10-25 07:20:00]
#       assert wt.start == ~N[2022-10-25 07:20:00]
#     end
